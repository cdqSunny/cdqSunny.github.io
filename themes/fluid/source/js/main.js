...
function wzx() {
  ...
  document.addEventListener('visibilitychange', function () {
    if (document.hidden) {
      ...
      document.title = '可爱的你走开啦!';
      clearTimeout(titleTime);
    } else {
      $('[rel="icon"]').attr('href', "https://cdn.jsdelivr.net/gh/cdqSunny/cdn/2.jpg");
      $('[rel="shortcut icon"]').attr('href', "https://cdn.jsdelivr.net/gh/cdqSunny/cdn/2.jpg");
      document.title = '哇.可爱的你又回来啦!';
